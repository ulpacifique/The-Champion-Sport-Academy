...
interface AdminLayoutProps {
    ...
    setActiveSection?: (section: string) => void;  // Add this
}
...
const AdminLayout = ({
    ...
    const menuItems = [
        ...
        { id: "athletes", label: "Athletes", icon: <IconUsers size={20} /> },
        { id: "coaches", label: "Coaches", icon: <IconUsers size={20} /> },
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-cerulean-blue-950">
            ...
            <div className="lg:hidden bg-gray-800 p-4 flex items-center justify-between">
                <div className="text-white font-bold text-xl">CSA Admin</div>
                <button
                ...
                `}>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2">
                        {menuItems.map((item) => (
                            <button
                                key={item.id}
                                onClick={() => setActiveSection(item.id)}  // Use the prop function
                                className={`
                    ...
                    <div className="border-t border-gray-700 mt-auto">
                        ...
                        <div className="px-4 pb-4">
                            ...
                            {/* Logout Button */}
                            <button className="w-full flex items-center justify-center space-x-2 p-3 text-red-400 hover:bg-red-400/10 rounded-lg transition-colors border border-red-400/20 hover:border-red-400/40">
                                <IconLogout size={20} />
                            ...
                            <div className="mt-4 text-center">
                                ...
                                <div className="text-white text-sm font-medium mt-1">Super Admin</div>
                                <div className="text-gray-500 text-xs mt-1">v2.1.0</div>
                            </div>
                        </div>
                    </div>
                </div>
