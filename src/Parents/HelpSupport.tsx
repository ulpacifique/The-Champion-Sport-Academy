            ...
            <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-6">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-gray-700/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-bright-sun-300 text-lg"
                    />
                </div>
            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                <button
                                    ...
                                    className={`p-4 rounded-xl border transition-all ${activeTab === "faq"
                                        ? 'bg-bright-sun-300/20 border-bright-sun-300/30'
                                        : 'bg-gray-700/50 border-gray-600/50 hover:border-bright-sun-300/30'}`}
                                >
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-6">
                        <div className="flex items-center space-x-3 mb-6">
                            <IconMessage className="text-bright-sun-300" size={24} />
                            ...
                            {supportContacts.map((contact) => (
                                <div key={contact.id} className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4">
                                    <div className="flex justify-between items-start mb-3">
                                        <div>
                                            <div className="text-bright-sun-300 font-bold text-sm">{contact.type}</div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center text-gray-300 text-sm">
                                            ...
                                            <a href={`mailto:${contact.email}`} className="hover:text-bright-sun-300">
                                                {contact.email}
                                            </a>
                                        </div>
                                        <div className="flex items-center text-gray-300 text-sm">
                                            <IconPhone size={16} className="mr-2" />
                                            <a href={`tel:${contact.phone}`} className="hover:text-bright-sun-300">
                                                {contact.phone}
                                            </a>
                                        </div>
                                        <div className="flex items-center text-gray-300 text-sm">
                                    ...
                                    <button className="w-full mt-4 py-2 bg-gradient-to-r from-bright-sun-200 to-bright-sun-300 text-gray-900 font-bold rounded-lg hover:shadow-lg transition-all">
                                        Contact Now
                                    </button>
                                </div>
                            ))}
                    ...
                    {/* Quick Action Guides */}
                    <div className="bg-gradient-to-r from-bright-sun-300/10 to-cerulean-blue-500/10 border border-bright-sun-300/20 rounded-2xl p-6">
                        <h3 className="text-xl font-semibold text-white mb-4">Quick Actions</h3>
                        <div className="space-y-3">
                            <button className="w-full text-left p-3 bg-gray-800/50 border border-gray-700/50 rounded-lg hover:border-bright-sun-300/30 transition-colors">
                            ...
                            <button className="w-full text-left p-3 bg-gray-800/50 border border-gray-700/50 rounded-lg hover:border-bright-sun-200/30 transition-colors">
            ...
            <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4">
                        ...
                        <button className="text-bright-sun-300 hover:text-bright-sun-200 text-sm font-medium mt-3">
                            View Guide →
                        </button>
                    </div>
                    <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4">
