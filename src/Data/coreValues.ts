...
export interface CoreValueItem {
  name: string;
  description: string;
  /** Short tagline for card layout (e.g. "Commitment to training, respect for rules, and consistent effort.") */
  tagline?: string;
  color: string;
  borderColor: string;
  iconColor: string;
...
export const coreValuesData: CoreValueItem[] = [
  {
    name: "Discipline",
    tagline: "Commitment to training, respect for rules, and consistent effort.",
  ...
  {
    name: "Friendship",
    tagline: "Sport bringing children together in unity and positive connections.",
  ...
  {
    name: "Teamwork",
    tagline: "Working together, supporting teammates, and growing as a group.",
  ...
  {
    name: "Respect",
    tagline: "Respect for self, others, coaches, rules, and the spirit of sport.",
  ...
  {
    name: "Excellence",
    tagline: "Striving to improve and reach one's full potential in sport and life.",
