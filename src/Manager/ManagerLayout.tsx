...
const ManagerLayout = ({
    ...
    const menuItems = [
        ...
        { id: "children", label: "Children", icon: <IconUsers size={20} />, badge: 2 },
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-cerulean-blue-950">
            ...
            <div className="lg:hidden bg-gray-800 p-4 flex items-center justify-between">
                <div className="text-white font-bold text-xl">CSA Manager</div>
                <button
                    ...
                    <div className="border-t border-gray-700 mt-auto">
                        ...
                        <div className="px-4 pb-4">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center space-x-2 p-3 text-red-400 hover:bg-red-400/10 rounded-lg transition-colors border border-red-400/20 hover:border-red-400/40"
                            >
                                <IconLogout size={20} />
                            ...
                            <div className="mt-4 text-center">
                                ...
                                <div className="text-white text-sm font-medium mt-1">Manager User</div>
                                <div className="text-gray-500 text-xs mt-1">Manager Portal v1.0.0</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-gray-400 mt-2">
                                    Manage academy operations and personnel
                                </p>
                            </div>
