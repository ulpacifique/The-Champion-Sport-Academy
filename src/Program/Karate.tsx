...
const Karate = () => {
    ...
    const programs = [
        {
            ...
            icon: <IconShield className="text-bright-sun-300" size={24} />,
        ...
        },
        {
            ...
            icon: <IconStar className="text-bright-sun-300" size={24} />,
    ...
    // Core Values
    const coreValues = [
        { name: "Discipline", icon: <IconShield className="text-bright-sun-300" size={24} />, description: "Commitment to consistent practice and excellence" },
        { name: "Friendship", icon: <IconFriends className="text-bright-sun-300" size={24} />, description: "Building supportive relationships through sport" },
        { name: "Teamwork", icon: <IconHeartHandshake className="text-bright-sun-300" size={24} />, description: "Collaborating for shared success and growth" },
        { name: "Respect", icon: <IconLeaf className="text-bright-sun-300" size={24} />, description: "Valuing coaches, teammates, and the sport" },
        { name: "Excellence", icon: <IconTrophy className="text-bright-sun-300" size={24} />, description: "Striving for personal and team best" }
    ];
                ...
                <div className="relative z-20 max-w-7xl mx-auto w-full text-center">
                    ...
                    >
                        <h1 className="text-5xl md:text-8xl font-black mb-6 leading-tight uppercase tracking-tighter">
                            Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-bright-sun-100 via-bright-sun-200 to-bright-sun-300">The Champions Karate</span>
                        </h1>
                    </motion.div>
                </div>
            </section>
            ...
            <main>
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <div className="relative order-2 lg:order-1">
                                <div className="absolute -inset-4 bg-gradient-to-tr from-bright-sun-300 to-transparent opacity-20 blur-2xl rounded-3xl"></div>
                                <img
                                ...
                                />
                                <div className="absolute -bottom-10 -right-10 bg-gradient-to-br from-bright-sun-100 to-bright-sun-300 p-8 rounded-3xl shadow-2xl z-20 hidden md:block">
                            ...
                            <div className="order-1 lg:order-2">
                                <h2 className="text-4xl md:text-5xl font-bold mb-8">Our Karate <span className="text-bright-sun-300 italic">Philosophy</span></h2>
                                ...
                                <div className="grid gap-6">
                                    {[
                                        ...
                                        >
                                            <div className="w-8 h-8 rounded-lg bg-bright-sun-300/20 flex items-center justify-center mr-4 shrink-0">
                                                <IconCheck className="text-bright-sun-300" size={18} />
                                            </div>
                ...
                <section className="py-24 px-4 md:px-8 lg:px-16 ">
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <h2 className="text-4xl md:text-6xl font-black mb-6">World-Class <span className="text-transparent bg-clip-text bg-gradient-to-r from-bright-sun-200 to-bright-sun-300">Programs</span></h2>
                                ...
                                >
                                    ...
                                    <div className="w-full lg:w-1/2 group">
                                        <div className="relative rounded-[2.5rem] overflow-hidden aspect-[4/3] shadow-2xl border border-white/5">
                                            ...
                                            <div className="absolute top-8 left-8 bg-bright-sun-300 text-gray-900 p-5 rounded-3xl shadow-2xl scale-110">
                                                {program.icon}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                                        <div className="text-bright-sun-300 font-black text-sm uppercase tracking-[0.3em] mb-4">Program {index + 1}</div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 w-full max-w-lg">
                                            {program.features.map((f, i) => (
                                                <div key={i} className="flex items-center text-gray-300">
                                                    <IconCheck className="text-bright-sun-300 mr-3 shrink-0" size={18} />
                                                    <span className="font-medium text-lg">{f}</span>
                                                </div>
                                            ))}
                                        </div>
                                        <div className="flex flex-col sm:flex-row items-center gap-6 w-full">
                                            <div className="flex items-center text-sm text-bright-sun-300 font-bold uppercase tracking-widest bg-white/5 py-3 px-6 rounded-2xl border border-white/10">
                                                <IconCalendar className="mr-3" size={18} />
                                                {program.schedule}
                                            </div>
                                            <Link
                                                to="/register"
                                                className="px-8 py-4 bg-bright-sun-300 text-gray-900 rounded-2xl font-black transition-all hover:scale-105 hover:shadow-[0_20px_40px_rgba(250,204,21,0.2)] text-center w-full sm:w-auto"
                                            >
                                                Join Program
                                            </Link>
                                        </div>
                ...
                <section className="py-24 px-4 md:px-8 lg:px-16 relative">
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <div>
                                <h2 className="text-4xl md:text-5xl font-black mb-4">The <span className="text-bright-sun-300 italic">Masters</span></h2>
                            ...
                            {instructors.map((instructor, index) => (
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        <div className="text-bright-sun-300 font-bold text-xs uppercase tracking-widest mb-2 px-2 py-1 bg-cerulean-blue-900/80 inline-block rounded-md border border-bright-sun-300/20">
                                            {instructor.rank}
                                        </div>
                ...
                <section className="py-24 px-4 md:px-8 lg:px-16">
                    <div className="max-w-7xl mx-auto">
                        <div className="grid lg:grid-cols-2 gap-16">
                            <motion.div {...fadeInUp}>
                                <h2 className="text-4xl font-bold mb-8">Access the <span className="text-bright-sun-300">Dojo</span></h2>
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between p-6 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                                            ...
                                            <div className="text-bright-sun-300 font-black text-right">{s.time}</div>
                                        </div>
                                    ))}
                                </div>
                            </motion.div>
                            ...
                            <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
                                <div className="h-full bg-cerulean-blue-900/50 rounded-3xl p-10 border border-white/10 flex flex-col justify-center">
                                    <div className="flex items-start mb-10">
                                        <div className="w-12 h-12 bg-bright-sun-300 rounded-2xl flex items-center justify-center mr-6 shadow-lg shadow-bright-sun-300/20">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        {["Pro Tatami Mats", "Full Sparring Gear", "Safety Monitored", "Parent Zones"].map((feat, i) => (
                                            <div key={i} className="flex items-center text-sm font-medium text-gray-300 bg-white/5 px-4 py-3 rounded-xl">
                                                <IconCheck className="text-bright-sun-300 mr-2 shrink-0" size={16} />
                                                {feat}
                                            </div>
                                        ))}
                                    </div>
                ...
                <section className="py-24 px-4 md:px-8 lg:px-16 bg-white/[0.02] border-t border-white/5">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-black mb-4 italic">Action <span className="text-bright-sun-300 Not-italic">Gallery</span></h2>
                        ...
                        {loadingGallery ? (
                            <div className="flex flex-col items-center py-20">
                                <motion.div
                                    ...
                                    className="w-10 h-10 border-4 border-bright-sun-300 border-t-transparent rounded-full mb-4"
                                />
                ...
                <section className="py-24 px-4 md:px-8 lg:px-16">
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, scale: 1 }}
                        className="max-w-5xl mx-auto bg-gradient-to-br from-bright-sun-100 to-bright-sun-300 rounded-[3rem] p-12 md:p-20 text-center text-gray-900 shadow-[0_40px_100px_rgba(250,204,21,0.2)] relative overflow-hidden group"
                    >
