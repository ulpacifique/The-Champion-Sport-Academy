...
const FOUNDER_BIO = [
    ...
    "He became the first karate coach in the world to receive an Olympic Solidarity Scholarship for Coaches following karate's inclusion in the Olympic Games programme. This prestigious scholarship enabled him to attend the CYSél – Cycle International du Sport d'Élite programme in Lausanne, Switzerland—an advanced international training programme for elite sport coaches.",
    "His coaching expertise focuses on Karate and Gymnastics, where he operates across children's sport development, high-performance athlete preparation, and coach education, contributing to the development of athletes and coaches at both national and international levels.",
    "At the international level, Noël has made significant contributions to sport-for-development and Olympic education initiatives. He served as Project Coordinator for the IOC Young Leaders initiative \"Best Holidays Karate for Children\", a project that uses karate as a tool for positive social change among youth.",
    "He also served as Chief Instructor in the project \"Open Martial Arts in Rwanda (Sports Initiative to Promote Women in Karate)\", implemented in collaboration with the International Centre of Martial Arts for Youth Development and Engagement under the auspices of UNESCO. This initiative aimed to promote women's participation in karate and to instill Olympic values—Excellence, Respect, and Friendship—among Rwandan students.",
    "In addition, Noël contributed to national coach development through the Karate Technical Course – Level 1 Project, organized by the Rwanda Karate Federation in cooperation with the World Karate Federation, and with financial support from Olympic Solidarity through the Rwanda National Olympic and Sports Committee. The course was directed by Antonio Oliva, a World Karate Federation expert and 8th Dan Black Belt, with Noël Nkuranyabahizi serving as Assistant Coach, supporting technical delivery and contributing to the development of coaches aligned with international standards.",
    "His professional engagement extends internationally in coach education, Olympic education, sport event management, and sport for youth development, positioning him as a leader at the intersection of performance sport and social impact.",
    "Noël is also a Professional Social Worker in Sport and an active member of the Alliance of Social Workers in Sport (United States of America). He has participated in and presented at international symposiums in the United States, including Denver (2019) and New Orleans (2023), addressing topics related to youth development through sport and coaches' mental well-being.",
    "He is also a member of Excellence Sans Frontières (ESF) (Switzerland), the global network of alumni from Sports Academy Lausanne, formerly known as the 3E Network, now part of the international S.A.L. alumni community, connecting elite sport professionals worldwide.",
    "He is currently pursuing a Master's Degree in Olympic Studies, Olympic Education, Organization and Management of Olympic Events at the International Olympic Academy and the University of Peloponnese, further strengthening his expertise in Olympic education, sport governance, and event management.",
];
