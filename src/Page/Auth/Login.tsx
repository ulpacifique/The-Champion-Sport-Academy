    ...
    return (
        <div className="animate-fade-in">
            <div className="relative mb-8 text-center">
                <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-bright-sun-200 via-bright-sun-100 to-bright-sun-200 drop-shadow-md pb-2">Welcome Back</h2>
                <p className="text-blue-100/90 text-sm">Sign in to access your dashboard</p>
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-20 h-1 bg-gradient-to-r from-transparent via-bright-sun-300 to-transparent opacity-50"></div>
            </div>
            ...
            <div className="space-y-5">
                ...
                <div className="group">
                    ...
                    <div className="relative transition-all duration-300 transform group-hover:-translate-y-1">
                        ...
                        <input
                            ...
                            disabled={loading}
                            className="w-full pl-12 pr-4 py-3.5 bg-black/20 border border-white/10 rounded-xl text-white placeholder-blue-200/30 focus:outline-none focus:border-bright-sun-300/50 focus:bg-black/30 backdrop-blur-md transition-all shadow-inner"
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between text-sm gap-4 pt-2">
                    <label className="flex items-center space-x-3 cursor-pointer group">
                        <div className="relative">
                            <input
                                ...
                                className="sr-only"
                            />
                            <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all duration-300 ${rememberMe ? "bg-gradient-to-br from-bright-sun-200 to-bright-sun-300 border-transparent shadow-[0_0_10px_rgba(250,204,21,0.5)]" : "bg-white/5 border-white/30 group-hover:border-white/50"
                                }`}>
                    ...
                    <button
                        ...
                        className="text-bright-sun-300 hover:text-bright-sun-200 transition-colors hover:underline decoration-bright-sun-300/30 underline-offset-4 font-medium"
                    >
                        Forgot Password?
                    </button>
                </div>
            ...
            <div className="mt-8 text-center pt-6 border-t border-white/10">
                ...
                <button
                    ...
                    className="text-bright-sun-200 font-bold text-sm hover:text-white transition-all hover:underline decoration-wavy decoration-bright-sun-200/30 underline-offset-4 ml-1"
                >
